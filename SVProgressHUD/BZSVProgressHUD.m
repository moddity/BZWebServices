...
@implementation BZSVProgressHUD
...
+ (BZSVProgressHUD*)sharedView {
    static dispatch_once_t once;
    static BZSVProgressHUD *sharedView;
...
+ (void)showImage:(UIImage *)image status:(NSString *)string {
    NSTimeInterval displayInterval = [[BZSVProgressHUD sharedView] displayDurationForString:string];
...
- (void)positionHUD:(NSNotification*)notification {
    ...
    if(notification) {
        ...
        BZSVProgressHUD *__unsafe_unretained weakSelf=self;
